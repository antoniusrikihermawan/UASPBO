...
public class NoteApp {
    ...
    public NoteApp(String databasePath) {
        noteService = new NoteService((DataStorage) new DatabaseStorage(databasePath));
    ...
    private void showMenu() {
        System.out.println("\nNote App Menu oleh : Antonius Riki Hermawan  NIM: 23201115.");
